...
use crate::memory::addressspace::{MemoryDevice, Address};
use crate::util;
...
use gdbstub::{arch, GdbStub, DisconnectReason, GdbStubError};
...
impl SingleThreadOps for RISCVTarget {
    fn resume(&mut self, action: ResumeAction, check_gdb_interrupt: &mut dyn FnMut() -> bool) -> Result<StopReason<<Self::Arch as Arch>::Usize>, Self::Error> {
